document.addEventListener("DOMContentLoaded", () => {
  ...
  if (formBusqueda && inputBusqueda && resultados) {
    const productosFicticios = [
      { nombre: "Pan Bimbo Blanco", precio: "$50.00", imagen: "./img/PAN_BIMBO_BLANCO_GRANDE.png" },
      { nombre: "Leche Lala 1L Negros", precio: "$29.00", imagen: "./img/leche_lala.jpg" },
      { nombre: "Coca Cola 2.5L", precio: "$47.00", imagen: "./img/Coca_2L.png" },
      { nombre: "Arroz Morelos 1kg", precio: "$28.00", imagen: "./img/Arroz.png" }
    ];
